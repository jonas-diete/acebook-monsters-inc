...
const password = encodeURIComponent("15081922");

const mongoDbUrl = process.env.MONGODB_URL || `mongodb+srv://makers:${password}@learning.vltc2du.mongodb.net/?retryWrites=true&w=majority`;
